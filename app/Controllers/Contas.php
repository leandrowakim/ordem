...
class Contas extends BaseController
{
    ...
    {        
        ...
        foreach ($contas as $conta) {          
            $data[] = [
                ...
                'valor_conta' => 'R$ ' . number_format($conta->valor_conta,2),
                'descricao_conta' => esc($conta->descricao_conta),
    ...
    public function cadastrar()
    {
        ...
        if ($this->contaPagarModel->save($conta)){
            ...
            $this->cadastraEventoDaConta($conta, $retorno['id']);

            $btnCriar = anchor("contas/criar", 'Cadastrar nova conta', ['class' => 'btn btn-danger mt-2']);
            
            session()->setFlashdata("sucesso","Conta cadastrada com sucesso!<br> $btnCriar");            
    ...
    public function exibir(int $id = null) 
    {
        ...
        $conta = $this->contaPagarModel->buscaConta($id);
    ...
    public function atualizar()
    {
        ...
        $conta = $this->contaPagarModel->buscaConta($post['id']);
    ...
    public function excluir(int $id = null) 
    {
        ...
        if ($this->request->getMethod() === 'post'){
            ...
            return redirect()->to(site_url("contas"))->with('sucesso', 'Conta do fornecedor '.esc($conta->razao).' excluída com sucesso!');
        };
    ...
    ///--- Métodos privados ---
    private function cadastraEventoDaConta(object $conta, int $contaId)
    {
        ...
        $valorConta = esc($conta->valor_conta);

        $tituloEvento = "Conta do fornecedor: $razao - CNPJ: $cnpj | R$ $valorConta";
