...
class AdicionaColunaOrdemIdToEventos extends Migration
{
    ...
    {
        $this->forge->dropForeignKey('eventos', 'eventos_ordem_id_foreign'); // Primeiro dropa a chave estrangeira
        $this->forge->dropColumn('eventos', 'ordem_id'); // Depois dropa a coluna inserida
    }
}
