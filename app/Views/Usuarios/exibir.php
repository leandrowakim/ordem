...
<div class="row">
   ...
   <div class='col-lg-4'>
      <div class="user-block block">
         ...
         <p class="contributions"><?php echo $usuario->exibeSituacao(); ?></p>
         <p class="card-text">Criado <?php echo esc($usuario->criado_em->humanize()); ?></p>
         <p class="card-text">Atualizado <?php echo esc($usuario->atualizado_em->humanize()); ?></p>         
         ...
         <div class="btn-group">
            ...
            <div class="dropdown-menu">
               ...
               <a class="dropdown-item" href="<?php echo site_url("usuarios/grupos/$usuario->id"); ?>">Gerenciar os grupos de acesso do usuário</a>
               <div class="dropdown-divider"></div>
               <?php if ($usuario->deletado_em == null): ?>
                  <a class="dropdown-item" href="<?php echo site_url("usuarios/excluir/$usuario->id"); ?>">Excluir usuário</a>
               <?php else: ?>
                  <a class="dropdown-item" href="<?php echo site_url("usuarios/recuperar/$usuario->id"); ?>">Recuperar usuário</a>
               <?php endif; ?>   
            </div>
         </div>
