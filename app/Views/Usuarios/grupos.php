      ...
      <div class="user-block block">
         ...
         <?php if(empty($gruposDisponiveis)): ?>
            ...
            <?php if($usuario->full_control == false): ?>
               <p class="contributions text-warning mt-0">Esse usuário já faz parte de todos os grupos disponíveis!</p>
            <?php else: ?>
               <p class="contributions text-warning mt-0">Esse usuário faz parte do grupo Administrador. Para associá-lo a outro grupo exclua-o do grupo Administrador!</p>
            <?php endif; ?>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        ?>
                        <?php echo form_open("usuarios/excluirgrupo/$info->id", $atributos); ?>
