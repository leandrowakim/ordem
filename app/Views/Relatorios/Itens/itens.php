      ...
      <div id="accordion">
         <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
               <div class="card-body">
                  Possibilita a geração de relatório em PDF de itens do tipo produto que estejam com o estoque zerado ou
                  negativo.
               </div>
               <div class="card-footer">
                  <a href="<?php echo site_url("relatorios/produtos-com-estoque-zerado-negativo"); ?>" target="_blank"
                     class="btn btn-dark btn-sm text-secondary">Gerar relatórios</a>
               </div>
            </div>
         </div>
         <div class="card">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
               <div class="card-body">
                  Possibilita a geração de relatório em PDF dos itens que foram mais vendidos, serão contempladas apenas
                  as Ordens de Serviço que estejam com o status de Encerrada.
...
<script>
   $(document).ready(function(){
      $("#form").on('submit',function(e){
         ...
         $.ajax({
            type: 'POST',
            url: '<?=site_url('relatorios/itensmaisvendidos'); ?>',
