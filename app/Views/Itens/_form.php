<div class="row">
   ...
   <?php if($item->id === null) : ?>
      ...
      <div class="col-md-4">
         <label>Este é um item tipo:</label>
         ...
         <div class="custom-control custom-radio mb-2">
            ...
            <label class="custom-control-label" for="servico"><i class="fa fa-wrench text-warning" aria-hidden="true"></i>&nbsp;Novo serviço</label>
         </div>
   ...
   <div class="servico form-group col-md-4">
      ...
      <input type="number" name="estoque" placeholder="insira o estoque do item" class="form-control"
...
<div class="row">
   ...
   <div class="servico form-group col-md-4">
      ...
      <input type="text" name="preco_custo" placeholder="insira o preço de custo do item" class="form-control money"
         value="<?php echo esc($item->preco_custo); ?>">
   </div>

   <div class="form-group col-md-4">
      <label class="form-control-label">Preço de venda</label>
      <input type="text" name="preco_venda" placeholder="insira o preço de venda do item" class="form-control money"
