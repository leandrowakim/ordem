...
<div class="row">
   <div class='col-lg-8'>
      ...
      <div class="user-block block">
         ...
         <p class="contributions text-warning mt-0">Esse grupo já possui todas as permissões de acesso disponíveis!</p>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        ?>
                        <?php echo form_open("grupos/excluirpermissoes/$permissao->id", $atributos); ?>
