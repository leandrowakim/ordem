...
<div class="custom-control custom-checkbox">
   ...
   <a tabindex="0" style="text-decoration: none ;" role="button" data-toggle="popover" data-trigger="focus"
               title="Importante"
               data-content="Se esse grupo for definido como <b class='text-danger'>exibir grupo de acesso</b> ele será mostrado como opção na hora de definir um <b>Responsável Técnico</b> pela ordem de serviço.">
