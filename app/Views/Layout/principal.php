...
<body>
            ...
            <div class="navbar-header">
               <!-- Navbar Header--><a href="<?php echo site_url('/') ;?>" class="navbar-brand">
                  <div class="brand-text brand-big visible text-uppercase"><strong
                        class="text-primary">Lw</strong><strong>Info</strong></div>
                  <div class="brand-text brand-sm"><strong class="text-primary">L</strong><strong>I</strong></div>
               </a>
               <!-- Sidebar Toggle Btn-->
   ...
   <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
         ...
         <ul class="list-unstyled">
            <li class="<?php echo (url_is('/') ? 'active' : '') ;?>">
               <a href="<?php echo site_url('/') ;?>"><i class="icon-home"></i>Home </a></li>
            
            <?php if(usuario_logado()->is_admin || usuario_logado()->is_cliente): ?>
               <li class="<?php echo (url_is('ordens*') ? 'active' : '') ;?>">
                  <a href="<?php echo site_url('ordens/minhas') ;?>"><i class="icon-windows"></i>Minhas Ordens </a>
               </li>
            <?php endif; ?>
            
            <?php if(usuario_logado()->temPermissaoPara('listar-ordens')): ?>
               <li class="<?php echo (url_is('ordens*') ? 'active' : '') ;?>">
                  <a href="<?php echo site_url('ordens') ;?>"><i class="icon-windows"></i>Ordens de Serviço </a>
               </li>
            <?php endif; ?>
            ...
            <?php if(usuario_logado()->temPermissaoPara('listar-clientes')): ?>
               <li class="<?php echo (url_is('clientes*') ? 'active' : '') ;?>">
                  <a href="<?php echo site_url('clientes') ;?>"><i class="icon-user"></i>Clientes </a>
               </li>
            <?php endif; ?>
            ...
            <?php if(usuario_logado()->temPermissaoPara('listar-contas')): ?>
               <li class="<?php echo (url_is('contas*') ? 'active' : '') ;?>">
                  <a href="<?php echo site_url('contas') ;?>"><i class="icon-user"></i>Contas a Pagar </a>
               </li>
            <?php endif; ?>

            <?php if(usuario_logado()->temPermissaoPara('listar-formas')): ?>
               <li class="<?php echo (url_is('formas*') ? 'active' : '') ;?>">
                  <a href="<?php echo site_url('formas') ;?>"><i class="icon-padnote"></i>Formas de Pagamento </a>
               </li>
            <?php endif; ?>

            <?php if(usuario_logado()->temPermissaoPara('listar-eventos')): ?>
               <li class="<?php echo (url_is('eventos*') ? 'active' : '') ;?>">
                  <a href="<?php echo site_url('eventos') ;?>"><i class="icon-chart"></i>Eventos </a>
               </li>
            <?php endif; ?>
            ...
            <?php if(usuario_logado()->temPermissaoPara('visualizar-relatorios')): ?>
               <li class="<?php echo (url_is('relatorios*') ? 'active' : '') ;?>"><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i
                        class="icon-windows"></i>Relatórios </a>
            ...
            <?php if(usuario_logado()->temPermissaoPara('visualizar-logs')): ?>
               <li class="<?php echo (url_is('logs*') ? 'active' : '') ;?>">
                  <a href="<?php echo site_url('logs') ;?>"><i class="icon-settings"></i>Analisar Logs </a>
               </li>
            <?php endif; ?>

            <li class="<?php echo (url_is('usuarios/editarsenha') ? 'active' : '') ;?>">
                <a href="<?php echo site_url('usuarios/editarsenha') ;?>"> <i class="icon-settings"></i>Alterar senha</a>
            </li>
      ...
      <div class="page-content">
         ...
         <sectionclass="no-padding-top no-padding-bottom">
            <div class="container-fluid">
            ...
            <footer class="footer">
               <div class="footer__block block no-margin-bottom">
                  <div class="container-fluid text-center">
                     ...
                     <p class="no-margin-bottom">2022-<?php echo date('Y'); ?> &copy; LW Informática-ME.</p>
                  </div>
               </div>
            </footer>
      </div>
